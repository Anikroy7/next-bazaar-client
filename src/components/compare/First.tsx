...
import CompareProductDetailsOne from "./CompareProductDetailsOne";
...
export default function First() {
  ...
  const searchField = watch("searchField1");
  ...
  return (
    <>
      ...
      {selectedProduct1 && (
        <CompareProductDetailsOne
          key={selectedProduct1}
          id={selectedProduct1}
        />
      )}
    </>
