...
import CompareProductDetailsTwo from "./CompareProductDetailsTwo";
...
export default function Second() {
  ...
  const searchField = watch("searchField2");
  ...
  return (
    <>
      ...
      {selectedProduct2 && (
        <CompareProductDetailsTwo
          key={selectedProduct2}
          id={selectedProduct2}
        />
      )}
    </>
