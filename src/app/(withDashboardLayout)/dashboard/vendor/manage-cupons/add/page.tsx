...
export default function AddCupon() {
  ...
  const { mutate: createCupon, isPending: createCuponPending, data: createdData } = useCreateCupon()
    ...
    <>
      ...
      <div className="flex w-full flex-col items-center justify-center">
        <div className="w-[70%]">
          ...
          >
            {(user) => (
              <SelectItem key={user.id} textValue={user.name} className="flex">
          ...
          >
            ...
            <div className="py-3">
              <NBInput label="Discount Amount" name="discountAmount" size="sm" />
            </div>
            {createCuponPending ? <Button
